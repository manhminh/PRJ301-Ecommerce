    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            try {
                ...
                List<OrderDetails> orders = odDAO.getAllItems(order.getId());
                request.setAttribute("orders", orders);
                List<OrderDetails> listOrderSoldOut = odDAO.getAllItemsSold(user.getId());

                request.setAttribute("listOrderSoldOut", listOrderSoldOut);
